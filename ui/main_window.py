...
class MainWindow(QMainWindow):
    ...
    def atualizar_estilos_css(self, is_dark: bool):
        ...
        scroll_css = f"""
            ...
            QScrollBar::sub-line:vertical, QScrollBar::add-line:vertical {{ background: {sb_button}; border: 1px solid {btn_border}; height: 14px; }}
            ...
            QScrollBar::sub-line:horizontal, QScrollBar::add-line:horizontal {{ background: {sb_button}; border: 1px solid {btn_border}; width: 14px; }}
